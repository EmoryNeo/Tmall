package edu.cczu.tmall.admin.category.controller;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import edu.cczu.tmall.admin.category.domain.Category;
import edu.cczu.tmall.admin.category.service.CategoryService;
import edu.cczu.tmall.admin.util.ImageUtil;
import edu.cczu.tmall.admin.util.Page;
import edu.cczu.tmall.admin.util.UUIDUtil;
import edu.cczu.tmall.admin.util.UploadedImageFile;
...
//        int total = categoryService.total();
    ...
    @RequestMapping(path = "/admin_property_list.do")
    public String doDispatch(String cid){
        // 完成Controller之间的跳转
        return "redirect:/admin_show_property_list.do" + "?cid="+cid+"";
    }
}
